    ...
    filteredVendors() {
      if (this.search) {
        return this.Vendors.filter((vendor) => {
          return (
            vendor.company.toLowerCase().match(this.search.toLowerCase()) ||
            vendor.email.toLowerCase().match(this.search.toLowerCase()) ||
            vendor.lastName.toLowerCase().match(this.search.toLowerCase()) ||
            vendor.firstName.toLowerCase().match(this.search.toLowerCase())
          );
        });
