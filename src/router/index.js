  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "api",
        components: {
          default: () => import("@/views/settings/Api.vue"),
        },
      },
      {
        path: "bank",
        components: {
          default: () => import("@/views/settings/Bank.vue"),
        },
      },
      {
        path: "integrations",
        components: {
          default: () => import("@/views/settings/Integrations.vue"),
        },
      },
      {
        path: "Organization",
      ...
      },
      {
        path: "apps",
        components: {
          default: () => import("@/views/settings/ThirdPartyApps.vue"),
        },
      },
    ],
