<template>
  <v-container>
    <!-- <v-skeleton-loader width="90%" type="table" :loading="loading"> -->
        ...
        <v-col cols="12">
          ...
          >
            <v-col class="pa-sm-0 d-flex align-center">
              <div class="pa-0" v-if="getAllInvocies.length > 0">
                <h3
          ...
          >
            <v-col class="pa-sm-0 d-flex align-center">
              ...
              <div class="pa-0 ma-0" v-if="getAllInvocies.length > 0">
                <h3
              ...
              <div class="mt-6 pa-0" v-if="(getAllInvocies.length = 0)">
                <h3
                  class="text-bold primary--text"
                  style="
                    font-style: normal;
          ...
          <!-- instructions when there is no invoice -->
          <v-row class="justify-center pt-0" v-if="getAllInvocies.length == 0">
            <p
              style="
                font-family: Inter;
                font-style: normal;
      ...
      <v-row v-if="getAllInvocies.length > 0">
        <v-col cols="12">
          <v-card
            flat
            elevation="6"
...
export default {
  ...
  async created() {
    ...
    if (this.getAllInvocies.length > 0) {
      this.loading = false;
  ...
  computed: {
    ...mapGetters({
      user: "auth/user",
      token: "auth/token",
      getAllInvocies: "invoices/getAllInvocies",
