<template>
  <div style="background: #fefcf8">
          ...
          >
            <div>
              <v-sheet
                ...
                max-width="250"
                color="#FF6A6A"
                class="d-flex align-center justify-center rounded-t text-center"
              >
                <span
                  style="
                    padding-right: 80px;
              ...
              <v-sheet
                ...
                max-width="250"
                color="#fff fff"
                class="d-flex flex-column justify-center rounded-b-sm"
              >
                <span
                  class="pl-6 pt-5 pb-2"
                  style="
                    font-family: Inter;
                    font-style: normal;
                    font-weight: bold;
    ...
    <!-- <v-btn @click="loadForm"> load Form </v-btn> -->
  </div>
</template>
